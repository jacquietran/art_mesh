...
# General params
iteration_id <- "mesh_0057"
initial_seed <- 3025157
bg_colour <- "#ffefd3"
panel_colour <- "#131313"
...
p <- ggplot2::ggplot() +
  ...
  ggforce::geom_diagonal(
    ...
    strength = end_points$strength, size = (0.2*end_points$size),
    colour = bg_colour, n = 500) +
  ggplot2::scale_colour_identity() +
  ggplot2::coord_equal(xlim = c(-5,13), ylim = c(-3,15), expand = FALSE) +
  ggplot2::theme_void() +
  ggplot2::theme(
